...
@implementation NSData (KL_Base64)
...
//
+ (NSData *)kl_dataFromBase64String:(NSString *)aString
{
	NSData *data = [aString dataUsingEncoding:NSASCIIStringEncoding];
	size_t outputLength;
	void *outputBuffer = KL_NewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)kl_base64EncodedString
{
	...
	char *outputBuffer =
		KL_NewBase64Encode([self bytes], [self length], false, &outputLength);
